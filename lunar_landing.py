...
while PlayAgain == True:
    ...
    while altitude > 0.0:
        ...
        print("current altitude=", round(altitude,2))
        print("current fuel=", round(fuel,2))
        print("current velocity=", round(velocity,2))
        print(round(second,2), "seconds has passed.")
        ...
        try:
            ...
            if burn<=fuel and burn>=0.0:
                ...
                if altitude<=0.0 and velocity >=10.0: 
                    print("Sorry! Unsafe landing at velocity =", round(velocity,2), "m/s.")
                    print("The landing took", round(second,2), "seconds.")
                    print(round(fuel,2), "liters of fuel is left.")

                if altitude<=0.0 and velocity <10.0:                    
                    print("Congratulations! Safe landing at velocity =", round(velocity,2), "m/s.")
                    print("The landing took", round(second,2), "seconds.")
                    print(round(fuel,2), "liters of fuel is left.")
